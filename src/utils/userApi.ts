...
export const loginUser = async (data: any) => {
  const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/user/sign-in`, data)
...
export const getDetailsUser = async (id: any, access_token: any) => {
  const res = await axiosJWT.get(`${process.env.NEXT_PUBLIC_API_URL}/user/get-details/${id}`, {
    headers: {
...
//   const res = await axiosJWT.delete(`${process.env.NEXT_PUBLIC_API_URL}/user/delete-user/${id}`, data, {
//     headers: {
//       token: `Bearer ${access_token}`
//     }
//   })
...
export const getAllUser = async (access_token: any) => {
  const res = await axiosJWT.get(`${process.env.NEXT_PUBLIC_API_URL}/user/getAll`, {
    headers: {
      token: `Bearer ${access_token}`
    }
  })
...
export const logoutUser = async () => {
  const res = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/user/log-out`)

  return res.data
}

export const updateUser = async (id: any, data: any, access_token: any) => {
  const res = await axiosJWT.put(`${process.env.NEXT_PUBLIC_API_URL}/user/update-user/${id}`, data, {
    headers: {
      token: `Bearer ${access_token}`
    }
  })
...
export const deleteManyUser = async (data: any, access_token: any) => {
  const res = await axiosJWT.post(`${process.env.NEXT_PUBLIC_API_URL}/user/delete-many`, data, {
    headers: {
      token: `Bearer ${access_token}`
    }
  })
